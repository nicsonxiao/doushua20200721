  ...
  <div>
    ...
    >
      <el-form-item label="机器ID" prop="machine_id">
          <el-input
            v-model="ruleForm.machine_id"
            @change="oninputMachine_id"
          >
          </el-input>
      </el-form-item>
    ...
    <el-table :data="tableData" border style="width: 100%" stripe>
      ...
      <el-table-column prop="err1" label="正常失败">
      </el-table-column>
      <el-table-column prop="err2" label="异常失败">
      </el-table-column>
...
export default {
  ...
  methods: {
    //默认最近一个月
      ...
      start = ((start.getTime() - 3600 * 1000 * 24 * 30) / 1000).formatDate("yMd","");
         return [start, end];
      },
    ...
    getlistbymachine(dataObj){
      this.$api.agent.taskcounter
            .listbymachine(dataObj)
            .then(res => {
              if(res.code===0){
